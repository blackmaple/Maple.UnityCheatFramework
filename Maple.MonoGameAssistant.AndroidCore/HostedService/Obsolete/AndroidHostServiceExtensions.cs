...
namespace Maple.MonoGameAssistant.AndroidCore.HostedService
{
    ...
    public static class AndroidHostServiceExtensions
    {
        ...
        //public static AndroidWebApiContext CreateGameAndroidService<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T_GAMECONTEXTSERVICE>
        //                (this AndroidWebApiContext  androidWebApiContext)
        //   where T_GAMECONTEXTSERVICE : class, IGameContextService
        //{

        //    _ = Task.Factory.StartNew(AndroidServiceTask, androidWebApiContext, TaskCreationOptions.LongRunning);
        //    return androidWebApiContext;

        //    static void AndroidServiceTask(object? obj)
        //    {
        //        if (obj is not AndroidWebApiContext context)
        //        {
        //            return;
        //        }
        //        var host = context.CreateAndroidService(p =>
